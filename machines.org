...
(setq dotfiles-directory "~/dotfiles"
      ...
      org-agenda-files `(,(f-join org-roam-directory "areas") ,(f-join org-roam-directory "areas/career/companies/iontra/iontra.org"))
...
*** Monitors
#+begin_src elisp :noweb-ref exwm-configs
(setq exwm-randr-workspace-monitor-plist '(0 "eDP-1" 1 "eDP-1" 2 "HDMI-1" 3 "HDMI-1"))
#+end_src
...
(setq org-directory "~/org"
      scrot-directory "~"
      org-agenda-files '("~/org/iontra.org")
...
("Task" :keys "t" :file "~/org/iontra.org" :olp ("Tasks") :template "* TODO %?")
#+end_src
