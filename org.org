...
(after! ivy
  ...
  (defun choose (prompt choices)
    "Choose an option from CHOICES using ivy"
...
templates"
  ...
  (setq org-capture-templates
        (doct `(("Inbox" :keys "i" :file ,(bookmark-get-filename "inbox") :template "* %?")
                ("Task" :keys "t" :file (lambda () (find-areas #'identity)) :olp ("Tasks") :template "* TODO %?")
                ("Event" :keys "e" :file (lambda () (find-areas #'identity)) :olp ("Events")
